...
COPY customer FROM 'benchmark/ssb/data/sf10/customer.csv' (HEADER);
...
COPY lineorder FROM 'benchmark/ssb/data/sf10/lineorder.csv'  (HEADER);
...
COPY part FROM 'benchmark/ssb/data/sf10/part.csv' (HEADER);
...
COPY supplier FROM 'benchmark/ssb/data/sf10/supplier.csv' (HEADER);
...
COPY date FROM 'benchmark/ssb/data/sf10/date.csv' (HEADER);
