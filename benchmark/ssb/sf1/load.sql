...
COPY customer FROM 'benchmark/ssb/data/sf1/customer.csv' (HEADER);
...
COPY lineorder FROM 'benchmark/ssb/data/sf1/lineorder.csv'  (HEADER);
...
COPY part FROM 'benchmark/ssb/data/sf1/part.csv' (HEADER);
...
COPY supplier FROM 'benchmark/ssb/data/sf1/supplier.csv' (HEADER);
...
COPY date FROM 'benchmark/ssb/data/sf1/date.csv' (HEADER);
